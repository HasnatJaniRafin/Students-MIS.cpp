//  Project     : Students MIS
//  Framework   : Framework for the projects 07
...
void menu()
{
    ...
    cout<<"\t\tx====================== The MIS MENU of Students ===========================x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx        1. Sort by Dormitory         2. Data of Statistics                 x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx        3. Sort by Student Number.   4. Sort by Phone                      x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx        5. Sort by Gender            6. Add Student                        x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx        7. Clear Data                 8. Save Data To File                 x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx        9. Show All Students        10. Modify Student                     x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx       11. Sort by Name.            12. Sort by WeChat                     x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx       13. Sort by Score            14. Load Data                          x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx       15. Show Selected Data       16. Search Student                     x"<<endl;
    cout<<"\t\tx                                                                           x"<<endl;
    cout<<"\t\tx       17. Delete Student           18. Exit                               x"<<endl;
    cout<<"\t\tx ==========================================================================x"<<endl;
